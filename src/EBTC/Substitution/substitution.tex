...
\begin{document}
    ...
    \begin{tabular}{|p{7cm}|p{7cm}|}
        \textbf{Pro}&\textbf{Kontra}\\
        \hline
        \multicolumn{2}{|c|}{\textbf{\bibleverse{Mat}(21:43)}}\\
        \hline
        Jesus lehnt die Juden ab und sagt, dass das Reich Gottes den Juden weggenommen wird und einem anderen Volk gegeben wird. & Das Reich Gottes wird einem damaligen ungläubigen Volk Israel weggenommen und einem zukünftigen gläubigen Volk Israel gegeben werden.
    \end{tabular}
\end{table}
    \begin{multicols}{2}
        \subsection*{Für den \sz}
        \begin{itemize}
            \item \textbf{\bibleverse{Mat}(21:43)} Jesus lehnt die Juden ab und sagt, dass das Reich Gottes den Juden weggenommen wird und einem anderen Volk gegeben wird.
            \item \textbf{\bibleverse{Gal}(6:16)} Die Gemeinde wird an dieser Stelle explizit als das \enquote{Israel Gottes} bezeichnet. Das Wörtchen \textit{kay} (und) sollte in einem erklärenden Sinn verstanden werden und nicht als und übersetzt werden.
            \item \textbf{\bibleverse{Rom}(9:6)} Paulus untescheidet angeblich zwischen dem ethnischen Osrael und einem geistlichen Israel, das aus allen Gläubigen besteht, auch den nicht jüdischen.
            \item \textbf{\bibleverse{Rom}(2:28-29)} Diese Stelle wird oft als Begründung für die Behauptung, der Begriff \enquote{Jude} beziehe sich auch auf die nicht jüdische Gemeinde.
            \item \textbf{\bibleverse{1Petr}(2:9-10)} Die Anwendung alttestamentlicher Bezeichnungen Israels auf die Gemeinde, ist in ihren Augen der Beweis dafür, dass die neutestamentlichen Schreiber die Gemeinde als das neue Israel definierten.
            \item \textbf{\bibleverse{Gal}(3:7.29)} Hier wird darauf hingewiesen, dass die \enquote{Nachkommenschaft Abrahams}, Jesus Christus, verwandt ist. Auch dies sei ein Beweis dafür, dass die Gemeinde mit Israel identisch ist.
            \item \textbf{\bibleverse{Eph}(2:11-22)} Die Ansicht ist, dass es unwahrscheinlich ist, dass Gott Juden und Nichtjuden zusammengeführt hat, nur um sie in der Zukunft wieder voneinander zu unterscheiden. Dies käme einem Schritt nach rückwärts gleich.
            \item \textbf{\bibleverse{Rom}(11:17-24)} In einer Analogie werden die ungläubigen Juden durch die abgebrochenen Zweige eines natürlichen Ölbaumes dargestellt, während die gläubigen Nichtjuden die Zweige eines wilden Ölbaumes sind, die in den natürlichen Ölbaum eingepfropft wurden.
            \item \textbf{\bibleverse{Hebr}(8:8-13)} Für viele \st en ist dies der Beweis dafür, dass sich der Neue Bund gänzlich in der Gemeinde erfüllt.            
            \item \textbf{Das Schweigen des Neuen Testaments} Das Fehlen einer ausdrücklichen Stelle über die Wiederherstellung des Volkes Israel im NT als zusätzlichen Beweis dafür, dass Israel durch die Gemeinde ersetzt wurde.
            \item \textbf{\bibleverse{Rom}(11:26)} 
            \begin{enumerate}
                \item Wenn Paulus davon spricht, dass \enquote{ganz Israel erettet werden wird}, dann meint er damit den gegenwärtigen Prozess der Errettung, wie er unter gläubigen Juden und Nichtjuden stattfindet, die gemeinsam das wahre Israel, die Gemeinde, bilden.
                ...
                \item Paulus spricht von einer zukünftigen, umfassenden Bekehrung der Juden zum Christentum spricht.
            \end{enumerate}
            
        \end{itemize}
        \subsection*{Gegen den \sz}
        \begin{itemize}
            \item \textbf{\bibleverse{Mat}(21:43)} Das Reich Gottes wird einem damaligen ungläubigen Volk Israel weggenommen und einem zukünftigen gläubigen Volk Israel gegeben werden.
            \item \textbf{\bibleverse{Gal}(6:16)} Der Kontext bestätigt jene Ansicht, wonach Paulus mit dem \enquote{Israel Gottes} die Judenchristen meinte. Es empfielt sich, \textit{kai} (und) so zu verstehen wie auch in den meisten anderen Stellen, wo dieses Wort vorkommt, und es in einem kopulativen oder kollektiven Sinn mit \enquote{und} zu übersetzten.
            \item \textbf{\bibleverse{Rom}(9:6)} Hier spricht der Vers von einem Israel innerhalb des ethnischen Volkes Israel. Paulus bezeichnet hier nicht gläubige Nichtjuden, sondern gläubige Juden als das wahre Israel.
            \item \textbf{\bibleverse{Rom}(2:28-29)} Mit \enquote{echten Juden} sind jene ethnischen Juden gemeint, die aufgrund ihres Glaubens eine Beziehung zu Gott haben.
            \item \textbf{\bibleverse{1Petr}(2:9-10)} Kann allenfalls als Hinweis dafür verstanden werden, dass der Begriff Volk GOttes auf die Nichtjuden ausgeweitet wurde. Dass die Gemeinde jedoch Israel ersetzt, ist keine zwingende Schlussfolgerung. Auch wenn Petrus seine Leser mit israelischen Bildern beschreibt, bezeichnet er sie nirgendwo als Israel.
            \item \textbf{\bibleverse{Gal}(3:7.29)} Im geistlichen Sinn können gläubige Nichtjuden als Nachkommen Abrahams bezeichnet werden. Abraham ist der Vater aller Gläubigen, sowohl der Nichtjuden als auch der Juden. Die Verwandtschaft mit Abraham durch den Glauben macht einen aber nicht automatisch zum Juden.
            \item \textbf{\bibleverse{Eph}(2:11-22)} Die Tatsache, dass die Nichtjuden einst ferne waren und jetzt nahe sind, dass sie einst ausgeschlossen waren und es jetzt nicht mehr sind, bedeutet nicht, dass sie Israels Identität angenommen hätten. Im Hinblick auf ihre Errettung, Segnungen und Stellung vor Gott stehen Heiden auf der gleichen Stufe wie gläubige Juden.
            \item \textbf{\bibleverse{Rom}(11:17-24)} Auch in diesem Beispiel werden gläubige Juden und Nichtjuden voneinander unterschieden. Durch diese heilsbezogene Einheit wird jedoch die einzigartige Rolle des Volkes Israel nicht aufgehoben.
            \item \textbf{\bibleverse{Hebr}(8:8-13)} Neben der Gemeinde wird also auch Israel bei seiner Errettung Anteil am Neuen Bund erhalten. Die Tatsache, dass die Gemeinde nur an den geistlichen Segnungen des Neuen Bundes Anteil erhielt, beweist, dass sie Israel nicht ersetzt hat.
            \item \textbf{Das Schweigen des Neuen Testaments} Da die neutestametlichen autoren als Juden mit dem Alten Testament vertraut waren, bestand in ihren Augen keine Notwendigkeit, alttestamentliche Verheissungen für Israels Zukunft zu wiederholen. Überdies stimmt es nicht, dass das Neue Testament nichts über eine Wiederherstellung Isreaels sagt. \bibleverse{Apg}(1:6), \bibleverse{Mat}(19:28)
            \item \textbf{\bibleverse{Rom}(11:26)} Wenn \bibleverse{Rom}(11:) eine zukünftige Errettung Israels auf der Grundlage des AT verheisst, dann dürfen wir auf derselben Grundlage auch eine Wiederherstellung der Nation erwarten. Da Isreaels Errettung in den alttestamentlichen Verheissungen verwurzelt ist, stellt sich die berechtiget Frage, warum die verheissene Wiederherstellung der Nation nicht stattfinden sollte.
        \end{itemize}
    \end{multicols}
\end{document}