...
% Makros für Nomen
\newcommand{\pers}[1]{\textcolor{prepcolor}{#1}}
...
\textbf{13} \konj{Und}\annot{Vortsetzung} kein Geschöpf ist[Präsens: Indikativ] vor ihm[Das Wort] verborgen[Partizip 2], 
sondern[Folge] alles ist[Präsens: Indikativ] enthüllt[Partizip2] 
\konj{und}[Aufzählung] aufgedeckt[Partizip 2] vor den Augen dessen{WESSEN AUGEN?}, 
dem[dessen] wir Rechenschaft zu geben[Infinitiv] haben[Präsens: Indikativ].

\textbf{14} Da[Quelle] wir nun[ZEIT] einen Grossen Hohepriester haben[Präsens: Indikativ], 
der[Jesus] die Himmel durchschritten hat[Perfekt: Indikativ], Jesus, den Sohn Gottes, 
so[Folge] lasst[Präsens: Imperativ] uns festhalten[Infinitiv] an dem Bekenntnis!

\textbf{15} Denn[Begründung] wir haben[Präsens: Indikativ] nicht einen Hohepriester, 
der kein Mitleid haben[Infinitv] könnte[Präteritum] mit unseren Schwachheiten, 
sondern[Gegensatz] einen[Hohepriester], 
der[Hohepriester],  
in allem versucht worden ist[Passiv] 
in ähnlicher Weise [wie wir], 
doch[Einschränkung] ohne Sünde.

\textbf{16} So[Folge] lasst[Präsens: Imperativ] uns 
Nun[Zeit] mit Freimütigkeit hinzutreten[Partizip 2] zum Thron der Gnade. 
Damit[Ergebnis] wir Barmherzigkeit erlangen[Präsens: Infinitiv] 
\konj{Und}[Aufzählung] Gnade finden zu rechtzeitiger Hilfe!
