...
\textbf{1} Was \vb{wollen}\annot{Präsens, Indikativ, Aktiv} wir \konj{nun}\annot{Gedankenschritt} \vb{sagen}\annot{Infinitiv}? 
    ...
    \spa{1}\konj{durch}\annot{Art} die Taufe in den Tod, 
        ...
        \spa{2}\konj{damit}\annot{Ziel}
            ...
            \spa{3}durch die Herrlichkeit des \person{Vaters} aus den Toten \verbP{auferweckt worden ist}\annot{Perfekt, Indikativ}, 

        \spa{2}\konj{so auch}\annot{Art und Weise} wir in einem neuen Leben \vb{wandeln}\annot{Präsens, Indikativ, Infinitiv}.
        
    \spa{1}\textbf{5}  \konj{Denn} wenn wir mit ihm einsgemacht und ihm gleich \vb{geworden sind} in seinem Tod, 

        \spa{2}\konj{so} \vb{werden} wir ihm \konj{auch} in der Auferstehung gleich \vb{sein};

        \spa{2}\textbf{6} wir \vb{wissen} ja dieses, 

            \spa{3}\konj{dass} unser \person{alter Mensch} \vb{mitgekreuzigt worden ist}, 

                \spa{4}\konj{damit} der Leib der Sünde ausser Wirksamkeit \vb{gesetzt sei}, 

                \spa{4}\konj{sodass} wir der Sünde nicht mehr \vb{dienen};

            \spa{3}\textbf{7}  \konj{denn} wer \vb{gestorben ist}, der ist von der Sünde \vb{freigesprochen}.

\spa{0}\textbf{8} \konj{Wenn} wir \konj{aber} mit \person{Christus} \vb{gestorben sind}, 
