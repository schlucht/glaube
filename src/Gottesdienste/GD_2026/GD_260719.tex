...
\begin{itemize}
    \item \info[b, p]{Bibel und Gebetsabend:} Do. 23. Juli 2026 20:00 Uhr Bibel- und Gebetsabend mit Tobias Rindlisbacher zu Markus 9,1-13.\\
    \item \info[b, p]{Nächster Gottesdienst:} So, 26. Juli 2026 mit Erich Maag.
...
\section{Input}
\begin{spacing}{1.5}
    \input{/workspaces/glaube/src/Theologie/Gott/9_DerVater}  
