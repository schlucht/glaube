...
\begin{itemize}
    ...
    \item[] \lied[b]{1. Lied: Alle Herren dieser Welt}
\end{itemize}
\section{Informationen}
\begin{itemize}
    \item \info[b, p]{Bibel und Gebetsabend:} Do. 16. Juli 2026 20:00 Uhr Bibel- und Gebetsabend mit Markus Steiger zu Markus 8,34-38.\\
...
\section{Input}
\begin{spacing}{1.5}
    \lied[b]{2. Lied: Christus ist mein ganzer halt}.
\end{spacing}
\section{Predigt}
...
\section{Abschluss}
\begin{itemize}
    \item [] \lied[b]{3. Lied: Schau ich zurück}.
