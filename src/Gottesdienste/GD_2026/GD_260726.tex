...
Auch dich Sonja und Erich \Name{} herzlich begrüssen. 

\begin{itemize}
    \item[] \beten[b, p]{Beten zur Begrüssung}
    \item[] und anschliessend singen wir zusammen das erste Lied
    \item[] \lied[b]{Stern auf den ich schaue}
\end{itemize}
\section{Informationen}
\begin{itemize}
    \item \info[b, p]{Bibel und Gebetsabend:} Do. 30. Juli 2026 20:00 Uhr Bibel- und Gebetsabend mit Elia Morise zu Markus 9,14-29.\\
...
\begin{spacing}{1.5}
    ...
    \lied[b]{Folge niemals dem Rat der Gottlosen Leute}.
\end{spacing}
\section{Predigt}
    von \Name{}
\section{Abschluss}
\begin{itemize}
    \item [] \lied[b]{In Christus ist mein ganzer Halt}.
