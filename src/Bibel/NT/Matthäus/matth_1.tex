...
\begin{auslegung}{Matthäus 1}
\versauslegung{1}{Schlachter}{
    Geschlechtsregister Jesu Christi, des Sohnes Davids, des Sohnes Abrahams.
}
{
    Das Jesus nicht der direkte Sohn von Abraham und David ist, sollte klar sein. Hier wird die Linie der Abstammung von Jesu Christi dargestellt. Abraham ist der Urvater vom Volk Israel oder den Juden, wie wir heute sagen.

    Die Juden das persönliche Volk von Gott. Gott hat Abraham versprochen, dass er ihm viele Nachkommen schaffen will und einer dieser Nachkommen wird das Zepter übernehmen.
}
\versauslegung{2}{Schlachter}{
    Abraham \verbN[b, p]{zeugte} den Isaak; Isaak zeugte den Jakob; Jakob zeugte den Juda und seine Brüder;
    }
    {
        \dots
    }
