...
\begin{spacing}{1.5}
    \begin{block}[Jahweh Adonai]
        ...
        \end{bibelbox}
        Das ist das Gebot das Jesus wiederholt, als er gefragt wurde, was denn das oberste Gebot ist. Dort spricht Jesus explizit von Herrn, dein Gott.
        ...
        \end{bibelbox}
        Auch hier wird Gott der Herr als persönlichen Gott vorgestellt. Es ist Gott der Herr der auf der neuen Erde das Licht sein wird.

    \end{block}
    \begin{block}[Ende]

        Dieser Name zeigt die persönliche Beziehung von Gott zu uns Menschen. Gott unser Herr. Der Herr, dein und mein persönlicher Gott. Aber nicht nur Persönlichkeit und Nähe drückt dieser Name aus, sondern auch seine Suveränität, seine Herrschaft, seine Allmacht. Gott ist nicht unser Kumpel. Gott ist unser Herr, dieser Gott gab uns das Leben, dieser Gott schenkt uns das hier alles. Er erschuf die Erde. 
        
        Der Mensch hatte nichts gegen einen Gott, aber Herr möchte er dann doch selber sein. Ja, der liebe Gott, der soll schauen das wir glücklich sind und es uns gut geht. Das reicht.

        Die Mehrheit heute sagt, ich bin mein eigener Herr ich brauche keinen Gott. Aber sieht es nicht immer mehr danach aus, dass wenn der Mensch Herr spielt, alles ins Chaos abrutscht?
        ...
        \end{bibelbox}
        Einfach verkündigen und der Rest überlassen wir dem Herrn.
    \end{block}
