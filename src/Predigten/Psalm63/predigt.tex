...
\section*{Psalm 63}
    ...
    \begin{block}
        ...
        \end{bibelbox}
        \betonung{Diese Aktion} hatte David die Macht Gottes und sein Souveränität gezeigt. David brachte die Lade zuerst nach Kirjat-Jearim, danach nach Obed-Edom und später unter Tanz und Reigen nach Jerusalem.
    \end{block}
